        ...
        <>
            <aside className={s.aside}>
                <div className={s.navigation}>
                    ...
                    <NavLink className={({ isActive }) => (isActive && s.activ)} to="/">
                        {/*<NavLink className={s.teamLink} to="/">*/}
                    ...
                    <NavLink to="/player" className={({ isActive }) => (isActive && s.activ)}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
{/*<NavLink className={({ isActive }) => (s.teamLink + " " + (isActive && s.activ))} to="/">*/ }